...
void setColour(long rgb)
{
    ledc_set_duty(LEDC_MODE, led_channels[0], 255 - ((rgb >> 16) & 0xFF));
    ledc_update_duty(LEDC_MODE, led_channels[0]);

    ledc_set_duty(LEDC_MODE, led_channels[1], 255 - ((rgb >> 8) & 0xFF));
    ledc_update_duty(LEDC_MODE, led_channels[1]);

    ledc_set_duty(LEDC_MODE, led_channels[2], 255 - ((rgb >> 0) & 0xFF));
